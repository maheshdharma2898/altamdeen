...
export default function ProjectsPage() {
    return (
        <div className="min-h-screen">
            {/* Hero */}
            <section className="pt-52 pb-20 relative overflow-hidden" style={{ background: '#0a1628' }}>
                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-wrap gap-3 justify-center">
                    {categories.map(c => (
                        <button
                            ...
                            style={{ border: '1px solid #e5e7eb', color: c === 'All' ? '#fff' : '#6b7280', background: c === 'All' ? '#0a1628' : 'transparent' }}
                        >
                            {c}
                        </button>
                    ))}
