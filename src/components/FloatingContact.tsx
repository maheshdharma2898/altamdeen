    ...
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-center">
          ...
          <div className="flex flex-col items-center mb-4 space-y-4">
            {socialLinks.map((link) => (
              <motion.a
                ...
                className="w-12 h-12 flex items-center justify-center rounded-full text-white shadow-lg transition-transform hover:scale-110 active:scale-95"
      ...
      <motion.button
        ...
        className={`w-14 h-14 flex items-center justify-center rounded-full shadow-2xl transition-all duration-300 ${
          isOpen ? 'bg-gray-800 text-white' : 'bg-[#c9a84c] text-white'
        }`}
      >
